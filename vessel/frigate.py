...
from weapon.lance_missiles_anti_surface import Lance_missiles_anti_surface


class Frigate(Vessel):
    def __init__(self, coordinates):
        super().__init__(coordinates = coordinates, max_hits = 5, weapon = Lance_missiles_anti_surface())
